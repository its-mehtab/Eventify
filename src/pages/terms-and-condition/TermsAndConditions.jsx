      ...
      <StandUpSection>
        <div className="main-content">
          ...
          <p>
            ...
            platform. By accessing or using our website, you agree to be bound
            by these terms. If you disagree with any part of the terms, please
          ...
          <p>
            ...
            responsible for any changes, cancellations, or rescheduling of
            events by third-party hosts.
          </p>
          ...
          <p>
            ...
            Please refer to the event's refund policy before booking. In
            general, tickets are non-refundable unless the event is cancelled.
          </p>

          <h3>5. Intellectual Property</h3>
          <p>
            All content on this site, including text, images, logos, and
            branding, is the intellectual property of our company or licensors.
          ...
          <p>
            ...
            attending an event or using our website. Our responsibility is
            limited to the services we provide directly.
          </p>

          <h3>7. Changes to Terms</h3>
          <p>
            We reserve the right to update these terms at any time. Continued
            use of our services following any updates will constitute acceptance
            of the new terms.
          </p>
        </div>
      </StandUpSection>
